...
myttree.Draw("ph_ptcone20/1e3>>phHFTMVA02","(weight_mc*weight_pileup*weight_leptonSF*weight_jvt*weight_bTagSF_77*event_norm * event_lumi )* ((ph_truthOrigin==23 || ph_truthOrigin==24 || ph_truthOrigin==25 || ph_truthOrigin==26 || ph_truthOrigin==27 || ph_truthOrigin==28 || ph_truthOrigin==29 || ph_truthOrigin==30 || ph_truthOrigin==31 || ph_truthOrigin==32 || ph_truthOrigin==33 || ph_truthOrigin==34 || ph_truthOrigin==35 || ph_truthOrigin==42) && ph_truthType == 16 && !( abs(ph_mc_pid)==11 || ( ph_mcel_dr<0.2 && ph_mcel_dr>=0 ) ) && mcChannelNumber==410501 && ph_pt > 20000 && ph_HFT_MVA < 0.2 && event_ngoodphotons==1 && ph_isTight)", "norm")
...
#gPad.SetLogz();
canvas.SaveAs("ph_ptcone20_CR_tight.png")
